...
export default function LivePage() {
  ...
  return <AppShell title="Live Monitoring">
    ...
    {cameras.isLoading && <LoadingPanel rows={6} label="Loading live monitoring"/>}{cameras.error && !cameras.data && <ErrorState error={cameras.error} onRetry={() => void cameras.refetch()}/>} 
