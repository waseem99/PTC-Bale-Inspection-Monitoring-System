...
import { AppShell, Freshness, Icon, LoadingPanel, QueryErrorState, StatusPill, healthTone } from '../components';
...
export default function HealthPage() {
  ...
  return <AppShell title="System Health">
    ...
    <QueryErrorState error={health.error} hasData={health.data !== undefined} onRetry={() => void health.refetch()}/>
