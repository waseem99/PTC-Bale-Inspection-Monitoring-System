...
- versioned REST API with frontend-compatible gateway routes.
...
- add request IDs, structured errors, limits, security headers and origin policy;
...
The backend must implement `docs/23-frontend-api-contract.md`.
