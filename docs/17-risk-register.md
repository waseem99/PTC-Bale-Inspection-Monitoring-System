...
| R-10 | Public repository exposes client project details | High | High | Make repository private before adding site data; prohibit footage, credentials, IPs, and evidence in Git | Repository owner |
...
- update after site survey, baseline AI evaluation, Azure design approval, and UAT;
