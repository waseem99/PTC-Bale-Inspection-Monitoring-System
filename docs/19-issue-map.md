...
- #25 — Implement durable local event spool and idempotent optional cloud synchronization
...
- #5 — Epic: Node.js API, MongoDB data layer, and Azure-aligned foundation
...
- #41 — Implement approved local access control and optional Microsoft Entra ID integration
...
- #44 — Build dashboard shell, approved local/cloud sign-in, routing, and authenticated API client
...
Start with #59, #14, #9, #11, #12, #13, #15, #16, #17, #20, and #35.
